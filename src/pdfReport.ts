...
import { DebateResult, ModelResponse } from './types';

function choiceToLetter(choiceIndex: number): string {
...
export function streamDebatePdf(debate: DebateResult, res: Response): void {
  res.setHeader('Content-Type', 'application/pdf');
  res.setHeader(
    'Content-Disposition',
    `attachment; filename="debate-report-${debate.sessionId}.pdf"`,
  );
